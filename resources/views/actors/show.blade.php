            ...
            <div class="md:ml-24">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            <a href="{{ $movie['link_to_page'] }}"><img src="{{ $movie['poster_path'] }}" alt="poster" class="transition duration-150 ease-in-out hover:opacity-75"></a>
                            <a href="{{ $movie['link_to_page'] }}" class="block mt-1 text-sm leading-normal text-gray-400 hover:text-white">
                                {{ $movie['title'] }}
                            </a>
                        </div>
                    @endforeach
